...
exports.deleteBook = exports.putBook = exports.postBook = exports.getBookID = exports.getBook = void 0;
...
const postBook = (req, res) => {
    const ultimoID = books[books.length - 1].id;
    const { titulo, autor, desc } = req.body;
    const nuevo = { id: ultimoID + 1, title: titulo, autor: autor, descripcion: desc };
    books.push(nuevo);
